@extends('Admin.index')
@section('page-title', 'Create Lecture')
@section('content')
...
<div class="container mt-5">
    <div class="card shadow-sm p-4">
        <h2 class="mb-4 text-center">Thêm mới thông tin bài giảng</h2>

        <form action="{{ route('save_lecture')}}" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="lecture_number" class="form-label">Lecture Number</label>
                    <div class="input-group">
                        <input style="margin-left: 35px" type="number" class="form-control" id="lecture_number" name="lecture_number" required>
            ...
            <div class="row mb-3" id="text-content" style="display: none;">
                <div class="col-md-12">
                    ...
                    <textarea class="form-control" id="text_content" name="text_content" required></textarea>
                </div>
            </div>
