            ...
            <div class="container-fluid ps-2 pe-0">
              ...
              <div class="collapse navbar-collapse" id="navigation">
                <ul class="navbar-nav mx-auto">
                  <li class="nav-item">
                    <a class="nav-link d-flex align-items-center me-2 active" aria-current="page" href="{{asset('public/BackEnd//pages/dashboard.html')}}">
                ...
                <div class="card-body">
                  <form role="form" action="{{ url('/admin/login') }}" method="POST">
                    ...
                    <?php
                      ...
                      if ($message) {
                          echo '
                          <div class="mt-2 alert alert-danger alert-dismissible text-white left-icon-big fade show">
                              ...
                              <div class="media">
                                  ...
                                  <div class="media-body">
                                      <h4 class="mt-1 mb-2" style="color: white">Không đăng nhập được!</h4>
                    ...
                    <p class="mt-4 text-sm text-center">
                      ...
                      <a href="{{URL::to('/register')}}" class="text-primary text-gradient font-weight-bold">Sign up</a>
                    </p>
                  </form>
                </div>
              </div>
