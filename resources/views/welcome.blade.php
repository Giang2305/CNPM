    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                <a href="{{URL::to('/home')}}" class="nav-item nav-link {{ Request::is('home') ? 'active' : '' }}">Home</a>
                <a href="about.html" class="nav-item nav-link">About</a>
                <a href="{{URL::to('/courses')}}" class="nav-item nav-link {{ Request::is('courses') ? 'active' : '' }}">Courses</a>
                ...
                <a href="#" class="nav-item nav-link"> <i class="fa-solid fa-cart-arrow-down fa-2xl"></i></a>
